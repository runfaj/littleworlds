...
public class EditFragmentTransition extends Fragment {
    ...
    private int getEnclosingCircleRadius(int cx, int cy) {
        ...
        int distanceTopLeft = (int) Math.hypot(realCenterX - left, realCenterY - top);
        int distanceTopRight = (int) Math.hypot(right - realCenterX, realCenterY - top);
        int distanceBottomLeft = (int) Math.hypot(realCenterX - left, bottom - realCenterY);
        int distanceBottomRight = (int) Math.hypot(right - realCenterX, bottom - realCenterY);
